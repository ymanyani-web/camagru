				...
				<section id="main">
					...
					<!-- Section -->
						<section class="ttt">
                            ...
                            <br>
                            <div class="info">
                                <form method="post" action="../controller/delete_my_account.php">
                                        <h1>Enter your password to Delete <br>definitely  your account</h1><br>
                                        <input type="hidden" value="<?php echo $user ?>" name="username">
                                        password: <input type="password" name="password"><br>
                                        <input type="submit" value="delete">
                                </form>
                                <div>
                                <font color="red" size="5px"><?php echo $msg1?></font>
                            </div>
